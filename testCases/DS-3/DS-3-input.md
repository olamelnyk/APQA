...
Create a detailed test plan for the [As an admin user, I want the system to prevent invalid or duplicate program names so that data integrity is maintained.] feature.
...
- store input (my propmt) in the DS-3/DS-3-input.md file
- store your output in the DS-3/DS-3-testcases.md file
